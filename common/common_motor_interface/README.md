...
| `encoder` | `int32_t` | Raw motor encoder value. In jog mode, target position commands use this value directly. | `0` |
...
| `encoder` | `int32_t` | 모터 raw encoder 값. jog mode에서는 position target 명령에 이 값을 그대로 사용 | `0` |
